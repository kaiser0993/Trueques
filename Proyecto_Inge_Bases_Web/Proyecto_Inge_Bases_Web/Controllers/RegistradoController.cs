...
namespace Proyecto_Inge_Bases_Web.Controllers
{
    public class RegistradoController : Controller
    {
        ...
        {
            if (verificarPrefNotificacion(correo))
            {
        ...
        public ActionResult ValidarInicioSesion(FormCollection form)
        {
            ...
            bool contraseñaValida = decoder.Compare(Contraseña1, usuario.Contrasena);
            ...
            //Verifica que la cuenta no este activa y envia correo al administrador.
            if ( (checkRespB1 == true) && (usuario.EstadoCuenta == false) )
            {
            ...
            {
                TempData["ImportError"] = "La cuenta ha sido bloqueada, por favor comunicate con un administrador";
                return RedirectToAction("IniciarSesion");
            }
            else
            {
