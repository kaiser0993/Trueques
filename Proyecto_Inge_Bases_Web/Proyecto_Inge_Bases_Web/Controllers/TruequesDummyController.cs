...
{
    public class TruequesDummyController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductoIDPublicador,CorreoPublicador,ProductoIDOfertante,CorreoOfertante,FechaInicio,Mensaje,Finalizado,Calificacion")] Trueque trueque)
        {
            if (ModelState.IsValid)
            {

                // Obtiene el tiempo del servidor de SQL

                //Me esta dando errores

                //trueque.InsertTimeTrueque(trueque);
                DateTime actual = DateTime.Now;
                trueque.FechaInicio = actual;
