...
AS Source ([ProductoID], Nombre, PrecioEstimado, Condicion, Descripcion, PathImagen1, PathImagen2, PathImagen3, Publicado, FechaRegistrado, FechaPublicado, Calificacion, CorreoCliente, Estado)
ON Target.ProductoID = Source.ProductoID AND Target.CorreoCliente = Source.CorreoCliente
WHEN NOT MATCHED BY TARGET THEN 
INSERT (Nombre, PrecioEstimado, Condicion, Descripcion, PathImagen1, PathImagen2, PathImagen3, Publicado, FechaRegistrado, FechaPublicado, Calificacion, CorreoCliente, Estado)
VALUES (Nombre, PrecioEstimado, Condicion, Descripcion, PathImagen1, PathImagen2, PathImagen3, Publicado, FechaRegistrado, FechaPublicado, Calificacion, CorreoCliente, Estado);
/*
...
USING (VALUES
       ('Categoría', 'joalva18@gmail.com', NULL, 1),
       ('Entretenimiento', 'joalva18@gmail.com',0 , 1),
       ('Educación', 'joalva18@gmail.com',0, 1),
       ('Salud y Belleza', 'joalva18@gmail.com', 0, 1),
       ('Deportes', 'joalva18@gmail.com', 0, 1),
       ('Ferreteria', 'joalva18@gmail.com', 0, 1),
       ('Hogar', 'joalva18@gmail.com',0, 1),
       ('Peliculas', 'joalva18@gmail.com',1 , 1),
       ('Juegos', 'joalva18@gmail.com',1 , 1),
       ('Libros', 'joalva18@gmail.com',1 , 1),
       ('Tecnología', 'joalva18@gmail.com',0 , 1),
       ('Material educativo', 'joalva18@gmail.com',2 , 1),
       ('Articulos educativos', 'joalva18@gmail.com',2, 1),
       ('Acción', 'joalva18@gmail.com',7 , 1)
...
USING (VALUES
 ( 10 , 1 ,  'joalva18@gmail.com'),
 ( 10 , 5 ,  'richixalfaro@gmail.com'),
 ( 2 , 4 ,  'richixalfaro@gmail.com')
 )
...
USING (VALUES
        ('12:10:16', NULL, 'joalva18@gmail.com','mariovargasc97@gmail.com',2),
        ('13:10:16', NULL, 'joalva18@gmail.com','mariovargasc97@gmail.com',1)
)
AS Source ([Fecha], Comentarios, Denunciante, Denunciado, Tipo)
ON Target.Fecha = Source.Fecha
WHEN NOT MATCHED BY TARGET THEN
INSERT (Fecha, Comentarios, Denunciante, Denunciado, Tipo)
VALUES (Fecha, Comentarios, Denunciante, Denunciado, Tipo);